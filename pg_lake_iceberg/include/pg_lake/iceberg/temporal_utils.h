...
extern PGDLLEXPORT int32_t DateYearFromUnixEpoch(DateADT date, IcebergOutOfRangePolicy policy);
...
extern PGDLLEXPORT int32_t DateMonthFromUnixEpoch(DateADT date, IcebergOutOfRangePolicy policy);
extern PGDLLEXPORT int32_t DateDayFromUnixEpoch(DateADT date, IcebergOutOfRangePolicy policy);
extern PGDLLEXPORT int32_t TimestampYearFromUnixEpoch(Timestamp timestamp, IcebergOutOfRangePolicy policy);
extern PGDLLEXPORT int32_t TimestampMonthFromUnixEpoch(Timestamp timestamp, IcebergOutOfRangePolicy policy);
extern PGDLLEXPORT int32_t TimestampDayFromUnixEpoch(Timestamp timestamp, IcebergOutOfRangePolicy policy);
extern PGDLLEXPORT int32_t TimestampHourFromUnixEpoch(Timestamp timestamp, IcebergOutOfRangePolicy policy);
