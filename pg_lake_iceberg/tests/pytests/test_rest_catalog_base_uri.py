...
BASE_URI_CASES = [
    ...
    # A lone trailing slash signals a root-mounted catalog (Iceberg spec at
    # /v1/ directly), NOT a bare Polaris host.  The slash is stripped and the
    # bare host is returned; templates then build https://host/v1/...
