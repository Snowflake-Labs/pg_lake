...
extern PGDLLEXPORT bool IsLakePartitionedTableById(Oid relationId);
extern PGDLLEXPORT bool IsLakePartitionedTable(RangeTblEntry *rte);
extern PGDLLEXPORT bool IsAnyLakeRelation(RangeTblEntry *rte);
